...
pictureTaking.PickPicture = ({InputStep, name, profilePicture, picture, BackStep}) => (
  <div>
    ...
    <Dropzone onDrop={profilePicture} multiple={false}>
      {picture?<img src={picture.url} className="profileImage Preview" />:<div className="previewText">Preview</div>}
    </Dropzone>
    </div>
      <div className="box">
  ...
  <div>
    ...
    <div className="dropzone_group">
      ...
      <Dropzone onDrop={set1} activeClassName='active-dropzone' multiple={false}>
        {pic1?<img src={pic1.url} className="Image1 Preview" />:<div className="previewText">Preview</div>}
      </Dropzone>
      </div>
      <div className="single">
      <Dropzone onDrop={set2} activeClassName='active-dropzone' multiple={false}>
        {pic2?<img src={pic2.url} className="Image2 Preview" />:<div className="previewText">Preview</div>}
      </Dropzone>
      </div>
      <div className="single">
      <Dropzone onDrop={set3} activeClassName='active-dropzone' multiple={false}>
        {pic3?<img src={pic3.url} className="Image3 Preview" />:<div className="previewText">Preview</div>}
      </Dropzone>
      </div>
      <div className="box">
